...
export default function Footer() {
  return (
    <div className="footer mx-[5%]">
      <Image src="/logofooter.svg" alt="" width={72} height={50} className="mb-5"></Image>
      <div className="footerlist flex justify-between mb-20">
        ...
        <div className=" hidden subscribe mt-8 lg:block">
            <p className="text-grayf text-[18px] ml-4 mb-3">Subscribe to our newsletter!</p>
            <div className="flex justify-between border-2 border-grayf rounded-[40px] w-[500px] cursor-text">
                <p className="text-grayf h-[60px] leading-[58px] align-middle ml-3 text-[16px] ">Enter your email</p>
                <div className="bg-red-500 rounded-[40px] w-[120px] h-[60px] text-black align-middle leading-[58px] text-center cursor-pointer ">Subscribe</div>
            </div>
        </div>
      </div>
      <div className="terms">
