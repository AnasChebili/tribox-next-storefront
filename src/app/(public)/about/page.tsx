...
export default function Home() {
  return (
    <>
      ...
      <section>
        ...
        <section className="mx-[5%]">
          <p>
            ...
            completely free to use in your next big project. We really do mean
            it when we say we love you.
          </p>
          <p className="mt-4">
      ...
      <section className="flex mx-[5%] my-24 justify-between items-center mb">
        <section>
          <Link href="/store">
        ...
        <section className=" space-x-3 hidden sm:flex">
